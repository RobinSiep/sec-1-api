...
def serve(settings):
    ...
    try:
        ...
        server = SimpleSSLWebSocketServer(settings['websocket.host'], settings['websocket.port'],
                                          cls, settings['websocket.cert'], settings['websocket.cert'],
                                          version=settings['websocket.version'])
